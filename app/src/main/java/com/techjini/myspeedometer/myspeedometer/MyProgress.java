...
public class MyProgress extends View {
    ...
    void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBackgroundColor = a.getColor(R.styleable.MyProgress_backgroundColor, getResources().getColor(android.R.color.darker_gray));
            mPrimaryProgressColor = a.getColor(R.styleable.MyProgress_progressColor, getResources().getColor(android.R.color.darker_gray));
            mSecondaryProgressColor = a.getColor(R.styleable.MyProgress_secondaryProgressColor, getResources().getColor(android.R.color.black));
            ...
            mTextColor = a.getColor(R.styleable.MyProgress_textColor, getResources().getColor(android.R.color.black));
